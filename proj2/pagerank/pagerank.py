...
def iterate_pagerank(corpus, damping_factor):
    ...
    while repeat:
        for page in corpus:
            ...
            new_rank[page] = (1 - damping_factor) / N + new_rank_value * damping_factor
        
        repeat=False
        for page in curr_rank:
            if abs(curr_rank[page] - new_rank[page]) >= 0.0001 :
                repeat = True
            curr_rank[page] = new_rank[page]        
